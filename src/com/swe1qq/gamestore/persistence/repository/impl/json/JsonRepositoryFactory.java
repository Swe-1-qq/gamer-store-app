...
import com.swe1qq.gamestore.persistence.exception.JsonFileIOException;
...
public final class JsonRepositoryFactory extends RepositoryFactory {
    ...
    private OrderJsonRepositoryImpl orderJsonRepositoryImpl;
    private PaymentJsonRepositoryImpl paymentJsonRepositoryImpl;
